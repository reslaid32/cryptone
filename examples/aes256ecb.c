...
main (void)
{
  ...
  uint8_t plaintext[64]
      = "ECB mode test: encrypting 64 bytes of message data!";
  ...
  AES_Context_ECB_Encrypt (ctx, plaintext, ciphertext, sizeof (plaintext));
  ...
  AES_Context_ECB_Decrypt (ctx, ciphertext, plaintext, sizeof (plaintext));
